  ...
  module.exports = function() {
    ...
    var ViewClass = function( args ) {
      try {
        ...
        var e_1 = new Tag('DIV');
        var e_2 = new Tag('P', ["textContent"]);
        var e_3 = new Tag('DIV');
        var e_4 = new TfwViewTextbox({ label: "N=" });
        var e_5 = new TfwViewTextbox({ label: "F=" });
        var e_6 = new TfwViewTextbox({ label: "H=" });
        $.add( e_3, e_4, e_5, e_6 );
        var e_flat = new Tag('CANVAS', ["width","height"]);
        this.$elements.flat = e_flat;
        $.add( e_1, e_2, e_3, e_flat );
        ...
        e_2.textContent = "Vous pouvez modifier N, F et H :";
        e_flat.width = 300;
        e_flat.height = 300;
        //------------------------
