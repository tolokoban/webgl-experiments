...
>>>>>>> d7def5850a86a5261357c67a9df2ddc9f498bfa4:js/@index2.js
        ...
        W('wdg.article0', 'wdg.article', {
          ...
          W({
              elem: "p",
              children: [W('wdg.icosahedron-11','wdg.icosahedron-1',{},{"id":"wdg.icosahedron-11"})]}),
          W({
              elem: "p",
              children: [
                W({
...
require("wdg.icosahedron-1",function(n,t,r){function o(){var n=a(this.$),t=new f(n,{vert:v.vert,frag:v.frag}),r=new f(n,{vert:v.shadow_vert,frag:v.shadow_frag}),o=l(),e=n.createBuffer();n.bindBuffer(n.ARRAY_BUFFER,e),n.bufferData(n.ARRAY_BUFFER,o,n.STATIC_DRAW),n.enable(n.DEPTH_TEST),n.clearColor(1,1,1,1),n.clearDepth(1),n.depthFunc(n.LESS),n.cullFace(n.BACK);var i=u.identity(),c=u.identity(),s=function(o){requestAnimationFrame(s);var a=n.canvas.clientWidth,l=n.canvas.clientHeight;m(n),u.perspective(.35*Math.PI,a/l,.1,10,i),u.rotationXY(3.27*Math.cos(458e-6*o),5.78*Math.sin(147e-6*o),c),n.clear(n.COLOR_BUFFER_BIT|n.DEPTH_BUFFER_BIT),r.use(),n.enable(n.CULL_FACE),r.$uniProjection=i,r.$uniRotation=c,r.$uniExpansion=h,r.bindAttribs(e,"attPoint","attNormal","attColor"),n.drawArrays(n.TRIANGLES,0,60),t.use(),n.disable(n.CULL_FACE),t.$uniProjection=i,t.$uniRotation=c,t.$uniExpansion=g;var v,f=o%38e3;f<19e3?(v=3*Math.ceil(f/200),v=Math.min(30,v)):(f-=19e3,v=3*Math.ceil(f/200),v=30+Math.min(30,v)),t.bindAttribs(e,"attPoint","attNormal","attColor"),n.drawArrays(n.TRIANGLES,0,v)};requestAnimationFrame(s)}function a(n){return n.getContext("webgl",{preserveDrawingBuffer:!0})}function e(n){void 0===n&&(n=1);var t,r,o=[0,0,n];for(t=0;t<5;t++)r=Math.PI*t*.4,o.push(n*Math.cos(r),n*Math.sin(r),.5);for(t=0;t<5;t++)r=Math.PI*(.4*t+.2),o.push(n*Math.cos(r),n*Math.sin(r),-.5);return o.push(0,0,-n),new Float32Array(o)}function i(){return new Uint16Array([0,1,2,0,2,3,0,3,4,0,4,5,0,5,1,1,6,2,2,7,3,3,8,4,4,9,5,5,10,1,11,10,9,11,9,8,11,8,7,11,7,6,11,6,10,10,6,1,6,7,2,7,8,3,8,9,4,9,10,5])}function l(){var n,t,r,o,a=e(),l=i(),c=[];for(n=0;n<20;n++){n<10?(t=1,r=.5,o=0):(t=0,r=0,o=.8);var v=a[3*l[3*n+0]+0],s=a[3*l[3*n+0]+1],u=a[3*l[3*n+0]+2],m=a[3*l[3*n+1]+0],f=a[3*l[3*n+1]+1],g=a[3*l[3*n+1]+2],h=a[3*l[3*n+2]+0],d=a[3*l[3*n+2]+1],C=a[3*l[3*n+2]+2],w=m-v,b=f-s,A=g-u,p=h-v,x=d-s,y=C-u,E=b*y-A*x,_=A*p-w*y,F=w*x-b*p;c.push(v,s,u,E,_,F,t,r,o,m,f,g,E,_,F,t,r,o,h,d,C,E,_,F,t,r,o)}return console.info("[wdg.multiball-1] vertices=",c),new Float32Array(c)}var c=function(){function t(){return o(r,arguments)}var r={en:{},fr:{}},o=n("$").intl;return t.all=r,t}(),v={vert:"uniform mat4 uniProjection;\nuniform mat4 uniRotation;\nuniform float uniExpansion;\n\nattribute vec3 attPoint;\nattribute vec3 attNormal;\nattribute vec3 attColor;\n\nvarying vec3 varNormal;\nvarying vec3 varColor;\n\nvoid main() {\n  varColor = attColor;\n  vec4 normal = uniRotation * vec4( attNormal, 1 );\n  varNormal = normal.xyz;\n  vec4 translation = vec4(0, 0, -2.5, 0);\n  vec4 vertex = uniRotation\n    * vec4( uniExpansion * attNormal + attPoint, 1 ) + translation;\n  gl_Position = uniProjection * vertex;\n}\n",frag:"precision mediump float;\n\nvarying vec3 varNormal;\nvarying vec3 varColor;\n\nconst vec3 WHITE = vec3(1, 1, 1);\nconst vec3 BLACK = vec3(0, 0, 0);\nconst vec3 LIGHT = normalize(vec3(-1,1,1));\n\nvoid main() {\n  vec3 color = varColor;\n  vec3 white = mix(color, WHITE, .7);\n  vec3 black = mix(color, BLACK, .7);\n  vec3 normal = normalize(varNormal);\n  float light = dot(normal, LIGHT);\n  if( light > 0.0 ) gl_FragColor = vec4( mix(varColor, white, light), 1.0 );\n  else gl_FragColor = vec4( mix(varColor, black, -light), 1.0 );  \n}\n",shadow_vert:"uniform mat4 uniProjection;\nuniform mat4 uniRotation;\nuniform float uniExpansion;\n\nattribute vec3 attPoint;\nattribute vec3 attNormal;\nattribute vec3 attColor;\n\nvarying vec3 varNormal;\nvarying vec3 varColor;\n\nvoid main() {\n  varColor = attColor * .1 + vec3(.5,.5,.5);\n  vec4 normal = uniRotation * vec4( attNormal, 1 );\n  varNormal = normal.xyz;\n  vec4 translation = vec4(0, 0, -2.5, 0);\n  vec4 vertex = uniRotation\n    * vec4( (1.0 + uniExpansion) * attPoint, 1 ) + translation;\n  gl_Position = uniProjection * vertex;\n}\n",shadow_frag:"precision mediump float;\n\nvarying vec3 varNormal;\nvarying vec3 varColor;\n\nconst vec3 WHITE = vec3(1, 1, 1);\nconst vec3 BLACK = vec3(0, 0, 0);\nconst vec3 LIGHT = normalize(vec3(-1,1,1));\n\nvoid main() {\n  float x = mod( gl_FragCoord.x, 2.0 );\n  float y = mod( gl_FragCoord.y, 2.0 );\n  if( x > 0.5 && y > 0.5) discard;\n  vec3 color = varColor;\n  vec3 black = BLACK;\n  vec3 white = WHITE;\n  vec3 normal = normalize(varNormal);\n  float light = dot(normal, LIGHT);\n  if( light > 0.0 ) gl_FragColor = vec4( mix(varColor, white, light), 1.0 );\n  else gl_FragColor = vec4( mix(varColor, black, -light), 1.0 );  \n}\n"},s={init:o},u=n("webgl.math").m4,m=n("webgl.resize"),f=n("webgl.program"),g=.06,h=.075;try{t.exports=function(){function t(n,t,r){return void 0===n[t]?r:n[t]}function r(n,t,r){r?o.addClass(n,t):o.removeClass(n,t)}var o=n("dom"),a=n("tfw.binding.property-manager"),e=n("tfw.view").Tag,i=n("tfw.binding.link"),l=n("tfw.view"),c=n("tfw.binding.converters");l.ensureCodeBehind(s,"init");var v=c.get("boolean");return function(n){try{void 0===n&&(n={}),this.$elements={};var c=this;a(this).create("fullscreen",{cast:v});var u=new e("CANVAS",["class"]);Object.defineProperty(this,"$",{value:u.$,writable:!1,enumerable:!1,configurable:!1}),l.events(u,{tap:function(n){c.fullscreen=!c.fullscreen}}),new i({A:{obj:c,name:"fullscreen"},B:{action:function(n){r(u,"fullscreen",n)}}}),u.class="thm-ele8 wdg-multiball-1",this.fullscreen=t(n,"fullscreen",!1),s.init.call(this),o.addClass(this,"view","custom")}catch(n){throw console.error("mod/wdg.icosahedron-1.js",n),Error('Instantiation error in XJS of "mod/wdg.icosahedron-1.js":\n'+n)}}}()}catch(n){throw Error('Definition error in XJS of "mod/wdg.icosahedron-1.js"\n'+n)}t.exports._=c});
