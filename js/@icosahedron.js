...
require("wdg.icosahedron-1",function(r,n,t){function o(){var r=a(this.$),n=new f(r,{vert:v.vert,frag:v.frag}),t=new f(r,{vert:v.shadow_vert,frag:v.shadow_frag}),o=l(),e=r.createBuffer();r.bindBuffer(r.ARRAY_BUFFER,e),r.bufferData(r.ARRAY_BUFFER,o,r.STATIC_DRAW),r.enable(r.DEPTH_TEST),r.clearColor(1,1,1,1),r.clearDepth(1),r.depthFunc(r.LESS),r.cullFace(r.BACK);var i=u.identity(),c=u.identity(),s=function(o){requestAnimationFrame(s);var a=r.canvas.clientWidth,l=r.canvas.clientHeight;m(r),u.perspective(.35*Math.PI,a/l,.1,10,i),u.rotationXY(3.27*Math.cos(458e-6*o),5.78*Math.sin(147e-6*o),c),r.clear(r.COLOR_BUFFER_BIT|r.DEPTH_BUFFER_BIT),t.use(),r.enable(r.CULL_FACE),t.$uniProjection=i,t.$uniRotation=c,t.$uniExpansion=h,t.bindAttribs(e,"attPoint","attNormal","attColor"),r.drawArrays(r.TRIANGLES,0,60),n.use(),r.disable(r.CULL_FACE),n.$uniProjection=i,n.$uniRotation=c,n.$uniExpansion=g;var v,f=o%38e3;f<19e3?(v=3*Math.ceil(f/200),v=Math.min(30,v)):(f-=19e3,v=3*Math.ceil(f/200),v=30+Math.min(30,v)),n.bindAttribs(e,"attPoint","attNormal","attColor"),r.drawArrays(r.TRIANGLES,0,v)};requestAnimationFrame(s)}function a(r){return r.getContext("webgl",{preserveDrawingBuffer:!0})}function e(r){void 0===r&&(r=1);var n,t,o=[0,0,r];for(n=0;n<5;n++)t=Math.PI*n*.4,o.push(r*Math.cos(t),r*Math.sin(t),.5*r);for(n=0;n<5;n++)t=Math.PI*(.4*n+.2),o.push(r*Math.cos(t),r*Math.sin(t),-.5*r);return o.push(0,0,-r),new Float32Array(o)}function i(){return new Uint16Array([0,1,2,0,2,3,0,3,4,0,4,5,0,5,1,1,6,2,2,7,3,3,8,4,4,9,5,5,10,1,11,10,9,11,9,8,11,8,7,11,7,6,11,6,10,10,6,1,6,7,2,7,8,3,8,9,4,9,10,5])}function l(){var r,n,t,o,a=e(),l=i(),c=[];for(r=0;r<20;r++){r<10?(n=1,t=.5,o=0):(n=0,t=0,o=.8);var v=a[3*l[3*r+0]+0],s=a[3*l[3*r+0]+1],u=a[3*l[3*r+0]+2],m=a[3*l[3*r+1]+0],f=a[3*l[3*r+1]+1],g=a[3*l[3*r+1]+2],h=a[3*l[3*r+2]+0],d=a[3*l[3*r+2]+1],C=a[3*l[3*r+2]+2],w=m-v,b=f-s,A=g-u,p=h-v,x=d-s,y=C-u,E=b*y-A*x,_=A*p-w*y,F=w*x-b*p;c.push(v,s,u,E,_,F,n,t,o,m,f,g,E,_,F,n,t,o,h,d,C,E,_,F,n,t,o)}return console.info("[wdg.multiball-1] vertices=",c),new Float32Array(c)}var c=function(){function n(){return o(t,arguments)}var t={en:{},fr:{}},o=r("$").intl;return n.all=t,n}(),v={vert:"uniform mat4 uniProjection;\r\nuniform mat4 uniRotation;\r\nuniform float uniExpansion;\r\n\r\nattribute vec3 attPoint;\r\nattribute vec3 attNormal;\r\nattribute vec3 attColor;\r\n\r\nvarying vec3 varNormal;\r\nvarying vec3 varColor;\r\n\r\nvoid main() {\r\n  varColor = attColor;\r\n  vec4 normal = uniRotation * vec4( attNormal, 1 );\r\n  varNormal = normal.xyz;\r\n  vec4 translation = vec4(0, 0, -2.5, 0);\r\n  vec4 vertex = uniRotation\r\n    * vec4( uniExpansion * attNormal + attPoint, 1 ) + translation;\r\n  gl_Position = uniProjection * vertex;\r\n}\r\n",frag:"precision mediump float;\r\n\r\nvarying vec3 varNormal;\r\nvarying vec3 varColor;\r\n\r\nconst vec3 WHITE = vec3(1, 1, 1);\r\nconst vec3 BLACK = vec3(0, 0, 0);\r\nconst vec3 LIGHT = normalize(vec3(-1,1,1));\r\n\r\nvoid main() {\r\n  vec3 color = varColor;\r\n  vec3 white = mix(color, WHITE, .7);\r\n  vec3 black = mix(color, BLACK, .7);\r\n  vec3 normal = normalize(varNormal);\r\n  float light = dot(normal, LIGHT);\r\n  if( light > 0.0 ) gl_FragColor = vec4( mix(varColor, white, light), 1.0 );\r\n  else gl_FragColor = vec4( mix(varColor, black, -light), 1.0 );  \r\n}\r\n",shadow_vert:"uniform mat4 uniProjection;\r\nuniform mat4 uniRotation;\r\nuniform float uniExpansion;\r\n\r\nattribute vec3 attPoint;\r\nattribute vec3 attNormal;\r\nattribute vec3 attColor;\r\n\r\nvarying vec3 varNormal;\r\nvarying vec3 varColor;\r\n\r\nvoid main() {\r\n  varColor = attColor * .1 + vec3(.5,.5,.5);\r\n  vec4 normal = uniRotation * vec4( attNormal, 1 );\r\n  varNormal = normal.xyz;\r\n  vec4 translation = vec4(0, 0, -2.5, 0);\r\n  vec4 vertex = uniRotation\r\n    * vec4( (1.0 + uniExpansion) * attPoint, 1 ) + translation;\r\n  gl_Position = uniProjection * vertex;\r\n}\r\n",shadow_frag:"precision mediump float;\r\n\r\nvarying vec3 varNormal;\r\nvarying vec3 varColor;\r\n\r\nconst vec3 WHITE = vec3(1, 1, 1);\r\nconst vec3 BLACK = vec3(0, 0, 0);\r\nconst vec3 LIGHT = normalize(vec3(-1,1,1));\r\n\r\nvoid main() {\r\n  float x = mod( gl_FragCoord.x, 2.0 );\r\n  float y = mod( gl_FragCoord.y, 2.0 );\r\n  if( x > 0.5 && y > 0.5) discard;\r\n  vec3 color = varColor;\r\n  vec3 black = BLACK;\r\n  vec3 white = WHITE;\r\n  vec3 normal = normalize(varNormal);\r\n  float light = dot(normal, LIGHT);\r\n  if( light > 0.0 ) gl_FragColor = vec4( mix(varColor, white, light), 1.0 );\r\n  else gl_FragColor = vec4( mix(varColor, black, -light), 1.0 );  \r\n}\r\n"},s={init:o},u=r("webgl.math").m4,m=r("webgl.resize"),f=r("webgl.program"),g=.06,h=.075;try{n.exports=function(){function n(r,n,t){return void 0===r[n]?t:r[n]}function t(r,n,t){t?o.addClass(r,n):o.removeClass(r,n)}var o=r("dom"),a=r("tfw.binding.property-manager"),e=r("tfw.view").Tag,i=r("tfw.binding.link"),l=r("tfw.view"),c=r("tfw.binding.converters");l.ensureCodeBehind(s,"init");var v=c.get("boolean");return function(r){try{void 0===r&&(r={}),this.$elements={};var c=this;a(this).create("fullscreen",{cast:v});var u=new e("CANVAS",["class"]);Object.defineProperty(this,"$",{value:u.$,writable:!1,enumerable:!1,configurable:!1}),l.events(u,{tap:function(r){c.fullscreen=!c.fullscreen}}),new i({A:{obj:c,name:"fullscreen"},B:{action:function(r){t(u,"fullscreen",r)}}}),u.class="thm-ele8 wdg-multiball-1",this.fullscreen=n(r,"fullscreen",!1),s.init.call(this),o.addClass(this,"view","custom")}catch(r){throw console.error("mod/wdg.icosahedron-1.js",r),Error('Instantiation error in XJS of "mod/wdg.icosahedron-1.js":\n'+r)}}}()}catch(r){throw Error('Definition error in XJS of "mod/wdg.icosahedron-1.js"\n'+r)}n.exports._=c});
