...
addListener(
    ...
    function() {
        ...
        W('wdg.article62', 'wdg.article', {"content": [
          W({
              elem: "p",
              children: [
                "  ",
                W('wdg.flex63','wdg.flex',{"content": [
                  W({
                      ...
                      children: [
                        "\n        ",
                        W('wdg.deform-164','wdg.deform-1',{
                          width: "420",
                          height: "420",
                          delay: "50"},{"id":"wdg.deform-164"}),
                        "\n          ",
                        W('wdg.flex65','wdg.flex',{"content": [
                          W('delay1','wdg.text',{
                          ...
                          W('angle1','wdg.text',{
                              label: "Angle max (deg)",
                              wide: "true",
                              value: "30"},{"id":"angle1"})]},{"id":"wdg.flex65"}),
                        "\n      "]}),
                  W({
                      elem: "div",
                      children: [
                        "\n        ",
                        W('wdg.deform-266','wdg.deform-2',{
                          width: "420",
                          height: "420",
                          delay: "50"},{"id":"wdg.deform-266"}),
                        "\n        ",
                        W('wdg.flex67','wdg.flex',{"content": [
                          W('delay2','wdg.text',{
                              label: "Delai par étage (ms)",
                              wide: "true",
                              value: "50"},{"id":"delay2"}),
                          W('angle2','wdg.text',{
                              label: "Angle max (deg)",
                              wide: "true",
                              value: "30"},{"id":"angle2"})]},{"id":"wdg.flex67"}),
                        "\n      "]})]},{"id":"wdg.flex63"})]}),
          W({
              elem: "p",
              children: [
          ...
          W({
              elem: "p",
              children: [W('wdg.showhide68','wdg.showhide',{
                  value: "false",
...
require("wdg.button",function(e,t,n){function o(e,t){return void 0===t&&(t={}),new i(DB.extend(e,t))}var r=function(){function t(){return o(n,arguments)}var n={en:{cancel:"Cancel",close:"Close",delete:"Delete",edit:"Edit",gotit:"Got it",no:"No",ok:"OK",save:"Save",yes:"Yes"},fr:{cancel:"Annuler",close:"Fermer",delete:"Supprimer",edit:"Editer",gotit:"J'ai compris",no:"Non",ok:"Valider",save:"Sauver",yes:"Oui"}},o=e("$").intl;return t.all=n,t}(),i=e("tfw.view.button");i.Cancel=function(e){return o({text:r("cancel"),icon:"cancel",flat:!0},e)},i.Close=function(e){return o({text:r("close"),icon:"close",flat:!0},e)},i.GotIt=function(e){return o({text:r("gotit"),flat:!0},e)},i.Delete=function(e){return o({text:r("delete"),type:"secondary",icon:"delete"},e)},i.No=function(e){return o({text:r("no"),icon:"cancel",flat:!0},e)},i.Ok=function(e){return o({text:r("ok"),flat:!0},e)},i.Edit=function(e){return o({text:r("edit"),type:"primary",icon:"edit"},e)},i.Save=function(e){return o({text:r("save"),type:"primary",icon:"save"},e)},i.Yes=function(e){return o({text:r("yes"),flat:!0},e)},i.default={content:"OK",icon:null,type:null},t.exports=i,t.exports._=r});
//# sourceMappingURL=wdg.button.js.map
require("tfw.view.button",function(e,t,n){function i(e){h(this).on("action",e)}function s(e){void 0!==e&&(this.tag=e),this.href.length>0?this.target.length>0?window.open(this.href,this.target):window.location=this.href:this.action=this.tag}function a(){var e=[];if(this.flat)if(this.pressed)switch(this.type){case"default":e.push("thm-bg3");break;case"primary":e.push("thm-bgP");break;case"secondary":e.push("thm-bgS")}else switch(this.type){case"primary":e.push("thm-fgP");break;case"secondary":e.push("thm-fgS")}else{switch(this.type){case"default":e.push("thm-bg3");break;case"primary":e.push("thm-bgP");break;case"secondary":e.push("thm-bgS")}this.pressed?e.push("thm-ele4"):e.push("thm-ele2")}return e}function o(e){this.$elements.icon.size=e?20:28}function r(e){32!=e.keyCode&&13!=e.keyCode||(e.preventDefault(),e.stopPropagation(),this.action=this.tag,this.pressed=!1)}var c=function(){function t(){return i(n,arguments)}var n={en:{cancel:"Cancel",close:"Close",delete:"Delete",edit:"Edit",gotit:"Got it",no:"No",ok:"OK",save:"Save",yes:"Yes"},fr:{cancel:"Annuler",close:"Fermer",delete:"Supprimer",edit:"Editer",gotit:"J'ai compris",no:"Non",ok:"Valider",save:"Sauver",yes:"Oui"}},i=e("$").intl;return t.all=n,t}(),l={getClasses:a,onSmallChanged:o,onKeyUp:r,on:i,fire:s},h=e("tfw.binding.property-manager");try{t.exports=function(){function t(e,t,n){return void 0===e[t]?n:e[t]}function n(e,t,n){n?a.addClass(e,t):a.removeClass(e,t)}function i(e,t,n){n?a.removeClass(e,t):a.addClass(e,t)}function s(e,t,n){n?a.removeAtt(e,t):a.att(e,t)}var a=e("dom"),o=e("tfw.binding.property-manager"),r=e("tfw.view").Tag,c=e("tfw.binding.link"),h=e("tfw.view"),d=e("tfw.binding.converters"),f=e("tfw.view.icon");h.ensureCodeBehind(l,"onSmallChanged","on","fire","onKeyUp");var u=d.get("string"),p=d.get("boolean"),m=d.get("enum"),w=d.get("unit"),b=d.get("isEmpty"),v=function(e){try{void 0===e&&(e={}),this.$elements={};var d=this,v=o(this);v.createAction("action"),v.create("tag",{cast:u}),v.create("icon"),v.create("content",{cast:u}),v.create("href",{cast:u}),v.create("target",{cast:u}),v.create("pressed",{cast:p}),v.create("flat",{cast:p}),v.create("type",{cast:m(["default","primary","secondary"])}),v.create("enabled",{cast:p}),v.create("inverted",{cast:p}),v.create("visible",{cast:p}),v.create("width",{cast:w}),v.create("wide",{cast:p}),v.create("responsive",{cast:p}),v.create("small",{cast:p});var g=new r("BUTTON",["class"]),y=new r("DIV",["class"]),C=new f;this.$elements.icon=C,a.add(y,C);var j=new r("DIV",["class"]);this.$elements.text=j,a.add(g,y,j),Object.defineProperty(this,"$",{value:g.$,writable:!1,enumerable:!1,configurable:!1}),h.events(g,{tap:l.fire.bind(this),keyup:l.onKeyUp.bind(this),down:function(e){d.pressed=!0},up:function(e){d.pressed=!1}}),new c({A:{obj:d,name:"flat"},B:{action:function(e){n(g,"flat",e)}}}),new c({A:{obj:d,name:"flat"},B:{action:function(e){g.applyClass(l.getClasses.call(d,e,"flat"),0)}}}),new c({A:{obj:d,name:"type"},B:{action:function(e){g.applyClass(l.getClasses.call(d,e,"type"),0)}}}),new c({A:{obj:d,name:"pressed"},B:{action:function(e){g.applyClass(l.getClasses.call(d,e,"pressed"),0)}}}),new c({A:{obj:d,name:"inverted"},B:{action:function(e){n(g,"inverted",e)}}}),new c({A:{obj:d,name:"visible"},B:{action:function(e){i(g,"hide",e)}}}),new c({A:{obj:d,name:"wide"},B:{action:function(e){n(g,"wide",e)}}}),new c({A:{obj:d,name:"responsive"},B:{action:function(e){n(g,"responsive",e)}}}),new c({A:{obj:d,name:"small"},B:{action:function(e){n(g,"small",e)}}}),new c({A:{obj:d,name:"enabled"},B:{action:function(e){s(g,"disabled",e)}}}),new c({A:{obj:d,name:"icon"},B:{obj:C,name:"content"}}),new c({A:{obj:d,name:"content"},B:{action:function(e){n(j,"hide",e)},converter:b}}),v.on("small",function(e){try{l.onSmallChanged.call(d,e)}catch(e){console.error('Exception in function behind "onSmallChanged" of module "mod/tfw.view.button.js" for attribute "small"!  '),console.error(e)}}),v.on("width",function(e){g.$.style.width=e}),v.on("content",function(e){a.clear(j,e)}),g.class="tfw-view-button",y.class="icon",j.class="text",this.tag=t(e,"tag","ACTION"),this.icon=t(e,"icon",""),this.content=t(e,"content","Click me!"),this.href=t(e,"href",""),this.target=t(e,"target",""),this.pressed=t(e,"pressed",!1),this.flat=t(e,"flat",!1),this.type=t(e,"type","primary"),this.enabled=t(e,"enabled",!0),this.inverted=t(e,"inverted",!1),this.visible=t(e,"visible",!0),this.width=t(e,"width","auto"),this.wide=t(e,"wide",!1),this.responsive=t(e,"responsive",!1),this.small=t(e,"small",!1),a.addClass(this,"view","custom")}catch(e){throw console.error("mod/tfw.view.button.js",e),Error('Instantiation error in XJS of "mod/tfw.view.button.js":\n'+e)}};return v.prototype.on=l.on,v.prototype.fire=l.fire,v}()}catch(e){throw Error('Definition error in XJS of "mod/tfw.view.button.js"\n'+e)}t.exports._=c});
