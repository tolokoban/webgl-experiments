...
addListener(
    ...
    function() {
        ...
        W('wdg.article62', 'wdg.article', {
          ...
          W({
              elem: "p",
              children: [W('wdg.gl463','wdg.gl4',{
                  width: "300",
                  height: "300"},{"id":"wdg.gl463","class":"right"})]}),
          W({
              elem: "p",
              children: [
          ...
          W({
              elem: "p",
              children: [W('wdg.showhide64','wdg.showhide',{
                  value: "false",
          ...
          W({
              ...
              children: [
                ...
                "&#39;",
                "outil et avec le GLSL (language des shaders)."]})]},{"id":"wdg.article62"})
