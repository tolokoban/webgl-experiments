...
addListener(
    ...
    function() {
        ...
        W('wdg.article82', 'wdg.article', {
          ...
          W({
              elem: "p",
              children: [W('wdg.intro183','wdg.intro1',{
                  float: "right",
                  height: "200"},{"id":"wdg.intro183"})]}),
          W({
              elem: "p",
              children: [
          ...
          W({
              elem: "p",
              children: [W('wdg.intro284','wdg.intro2',{
                  float: "right",
                  width: "200",
                  height: "200"},{"id":"wdg.intro284"})]}),
          W({
              elem: "p",
              children: [
