...
addListener(
    ...
    function() {
        ...
        W('wdg.article91', 'wdg.article', {
          ...
          W({
              elem: "p",
              children: [W('wdg.intro192','wdg.intro1',{
                  float: "right",
                  height: "200"},{"id":"wdg.intro192"})]}),
          W({
              elem: "p",
              children: [
          ...
          W({
              elem: "p",
              children: [W('wdg.intro293','wdg.intro2',{
                  float: "right",
                  width: "200",
                  height: "200"},{"id":"wdg.intro293"})]}),
          W({
              elem: "p",
              children: [
