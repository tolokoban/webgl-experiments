...
addListener(
    ...
    function() {
        ...
        W('wdg.article114', 'wdg.article', {
          ...
          W({
              elem: "p",
              children: [W('wdg.intro1115','wdg.intro1',{
                  float: "right",
                  height: "200"},{"id":"wdg.intro1115"})]}),
          W({
              elem: "p",
              children: [
          ...
          W({
              elem: "p",
              children: [W('wdg.intro2116','wdg.intro2',{
                  float: "right",
                  width: "200",
                  height: "200"},{"id":"wdg.intro2116"})]}),
          W({
              elem: "p",
              children: [
          ...
          W({
              elem: "h1",
              attr: {"id": "comment-sont-stoqu-s-les-attributs-en-m-moire-"},
              children: ["Comment sont stoqués les attributs en mémoire ?"]}),
          W({
              elem: "p",
              children: [
                "Comme on l",
                "&#39;",
                "a vu, les attributs sont stoqués dans un tableau.\nIls sont donc donc placés les uns à la suite des autres.\nDans l",
                "&#39;",
                "exemple du triangle, on les a placé comme ceci :"]}),
          W({
              elem: "p",
              children: [W({
                  elem: "div",
          ...
          W({
              elem: "p",
              children: ["Mais on aurait pu aussi les placer comme ceci :"]}),
          W({
              elem: "p",
              children: [W({
                  elem: "div",
          ...
          W({
              elem: "p",
              children: ["Pour cela, il aurait fallu modifier le code comme ceci :"]}),
          W({
              elem: "p",
              children: [W({
                  elem: "pre",
          ...
          W({
              elem: "p",
              children: ["Voici comment la carte graphique procède pour lire les trois attributs de chaque vertex :"]}),
          W({
              elem: "p",
              children: [W({
                  elem: "pre",
          ...
          W({
              ...
              children: [
                ...
                "&#39;",
                "avez pas besoin de toucher aux données concernant les textures."]}),
          W({
              elem: "p",
              children: [
                "Une bonne optimisation serait donc de n",
                "&#39;",
                "envoyer dans la carte graphique que les\nattributs concernant les coordonnées 3D. Mais pour cela, il faut les stoquer dans\ndeux blocs différents, comme ceci :"]}),
          W({
              elem: "p",
              children: [W({
                  elem: "code",
                  children: ["x1, y1, z1, x2, y2, z2, ..., u1, v1, u2, v2, ..."]})]}),
          W({
              elem: "p",
              children: [
                "Je vous laisse imaginer comment utiliser la fonction ",
                W({
                  elem: "code",
                  children: ["vertexAttribPointer"]}),
                "\npour obtenir un tel agencement."]})]},{"id":"wdg.article114"})
...
require("wdg.intro2",function(r,t,o){var n=function(){function t(){return n(o,arguments)}var o={en:{},fr:{}},n=r("$").intl;return t.all=o,t}();t.exports=r("draw")(function(){this.axes().setColor("orange").fillTri(-.7,-.5,-.1,.7,.5,-.8).setColor("#000").dot(-.7,-.5,"A (-0.7,-0.5)","B").dot(-.1,.7,"B (-0.1,0.7)","B").dot(.5,-.8,"C (0.5,-0.8)","T")}),t.exports._=n});
//# sourceMappingURL=wdg.intro2.js.map
...
require("wdg.intro1",function(t,o,r){var n=function(){function o(){return n(r,arguments)}var r={en:{},fr:{}},n=t("$").intl;return o.all=r,o}();o.exports=t("draw")(function(){this.axes().dot(1,0).dot(-1,0).dot(0,1).dot(0,-1).dot(0,0,"(0,0)").dot(-.7,.2,"(-0.7,0.2)").setColor("#06F").txtB("x=+1",1,0).txtT("x=-1",-1,0).txtB("y=+1",0,1).txtT("y=-1",0,-1)}),o.exports._=n});
//# sourceMappingURL=wdg.intro1.js.map
