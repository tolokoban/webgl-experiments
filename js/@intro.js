...
addListener(
    ...
    function() {
        ...
        W('wdg.article90', 'wdg.article', {
          ...
          W({
              elem: "p",
              children: [W('wdg.intro191','wdg.intro1',{
                  float: "right",
                  height: "200"},{"id":"wdg.intro191"})]}),
          W({
              elem: "p",
              children: [
          ...
          W({
              elem: "p",
              children: [W('wdg.intro292','wdg.intro2',{
                  float: "right",
                  width: "200",
                  height: "200"},{"id":"wdg.intro292"})]}),
          W({
              elem: "p",
              children: [
