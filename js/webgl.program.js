...
require('webgl.program', function (require, module, exports) {
  var _ = function () {
    var D = {
      "en": {},
      "fr": {}
  ...
  function getSize(gl, item) {
    switch (item.type) {
      ...
      default:
        throw "[webgl.program:getSize] I don't know the size of the attribute '" + item.name + "' because I don't know the type " + getTypeName(item.type) + "!";
    }
  }
