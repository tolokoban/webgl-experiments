...
require("draw",function(t,i,e){function n(t,i){var e,n;for(e in i)n=i[e],Object.defineProperty(t,e,{value:n,writable:!1,configurable:!1})}var r=function(){function i(){return n(e,arguments)}var e={en:{},fr:{}},n=t("$").intl;return i.all=e,i}(),o=t("dom");i.exports=function(t){var i=function(i){void 0===i&&(i={}),void 0===i.width&&(i.width=300),void 0===i.height&&(i.height=300),i.width=parseInt(i.width),i.height=parseInt(i.height),"number"!=typeof i.width&&(i.width=300),"number"!=typeof i.height&&(i.height=300);var e=o.tag("canvas",{width:i.width,height:i.height});o.css(e,{boxShadow:"none",background:"transparent"}),"string"==typeof i.float&&o.css(e,{float:i.float});var r=e.getContext("2d");r.clearRect(0,0,i.width,i.height),r.lineJoin="round",this.element=e,n(this,{_ctx:r,_w:i.width,_h:i.height,X:function(t){var e=i.width;return.5*e+t*(.5*e-20)},Y:function(t){var e=i.height;return.5*e-t*(.5*e-20)}}),this.setColor("#000"),r.font="11px sans-serif",t.call(this,i)};return i.prototype.setColor=function(t){return this._ctx.fillStyle=t,this._ctx.strokeStyle=t,this},i.prototype.setLine=function(t){return this._ctx.lineWidth=t,this},i.prototype.fillRect=function(t,i,e,n){t=this.X(t),i=this.Y(i),e=this.X(e),n=this.Y(n);var r=Math.min(t,e),o=Math.min(i,n),h=Math.max(t,e)-r,s=Math.max(i,n)-o;return console.info("[draw] x, y, w, h=",r,o,h,s),this._ctx.fillRect(r,o,h,s),this},i.prototype.axes=function(){var t=this._ctx;t.save(),this.setColor("#ddd").fillRect(-1,-1,1,1).setColor("#aaa");var i=this._w,e=Math.floor(.5*i)-.5,n=this._h,r=Math.floor(.5*n)-.5;return t.beginPath(),t.moveTo(0,r),t.lineTo(i,r),t.moveTo(e,0),t.lineTo(e,n),t.stroke(),t.restore(),this},i.prototype.dot=function(t,i,e,n){var r=this.X(t),o=this.Y(i),h=this._ctx;return h.beginPath(),h.arc(r,o,3,0,2*Math.PI,!0),h.fill(),"string"==typeof e&&this.txt(e,t,i,n||"LB"),this},i.prototype.txt=function(t,i,e,n){"string"!=typeof n&&(n=""),n=n.toUpperCase(),i=this.X(i),e=this.Y(e);var r=this._ctx;return-1!==n.indexOf("L")?(r.textAlign="start",i+=4):-1!==n.indexOf("R")?(r.textAlign="end",i-=4):r.textAlign="center",-1!==n.indexOf("T")?(r.textBaseline="top",e+=4):-1!==n.indexOf("B")?(r.textBaseline="bottom",e-=4):r.textBaseline="middle",console.info("[draw] ctx.textBaseline, text=",r.textBaseline,t),r.fillText(t,i,e),this},i.prototype.drawLine=function(t,i,e,n){t=this.X(t),i=this.Y(i),e=this.X(e),n=this.Y(n);var r=this._ctx;return r.beginPath(),r.moveTo(t,i),r.lineTo(e,n),r.stroke(),this},i.prototype.tri=function(t,i,e,n,r,o){t=this.X(t),i=this.Y(i),e=this.X(e),n=this.Y(n),r=this.X(r),o=this.Y(o);var h=this._ctx;return h.beginPath(),h.moveTo(t,i),h.lineTo(e,n),h.lineTo(r,o),h.closePath(),this},i.prototype.fillTri=function(t,i,e,n,r,o){var h=this._ctx;return this.tri(t,i,e,n,r,o),h.fill(),this},i.prototype.drawTri=function(t,i,e,n,r,o){var h=this._ctx;return this.tri(t,i,e,n,r,o),h.stroke(),this},i.prototype.txtLB=function(t,i,e){return this.txt(t,i,e,"LB")},i.prototype.txtL=function(t,i,e){return this.txt(t,i,e,"L")},i.prototype.txtR=function(t,i,e){return this.txt(t,i,e,"R")},i.prototype.txtT=function(t,i,e){return this.txt(t,i,e,"T")},i.prototype.txtB=function(t,i,e){return this.txt(t,i,e,"B")},i.prototype.txtLT=function(t,i,e){return this.txt(t,i,e,"LT")},i.prototype.txtLB=function(t,i,e){return this.txt(t,i,e,"LB")},i.prototype.txtRT=function(t,i,e){return this.txt(t,i,e,"RT")},i.prototype.txtRB=function(t,i,e){return this.txt(t,i,e,"RB")},i},i.exports._=r});
