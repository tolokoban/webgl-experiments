  ...
  module.exports = function() {
    ...
    var ViewClass = function( args ) {
      try {
        ...
        pm.create("icon", { cast: conv_string });
        ...
        pm.create("type", { cast: conv_enum(["primary","default","secondary"]) });
        ...
        pm.create("wait", { cast: conv_boolean });
        ...
        this.wait = defVal(args, "wait", false);
