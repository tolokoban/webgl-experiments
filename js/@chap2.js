...
<<<<<<< HEAD
                    ...
                    W('wdg.gl242','wdg.gl2',{
                      width: "200",
                      height: "200",
                      size: "3"},{"id":"wdg.gl242","name":"wdg.gl2"}),
                    "\r\n    "]}),
=======
                    "\n        ",
                    W('wdg.gl241','wdg.gl2',{
...
<<<<<<< HEAD
                    ...
                    W('wdg.gl243','wdg.gl2',{
                      width: "200",
                      height: "200",
                      size: "5"},{"id":"wdg.gl243","name":"wdg.gl2"}),
                    "\r\n    "]}),
=======
                    "\n        ",
                    W('wdg.gl242','wdg.gl2',{
...
<<<<<<< HEAD
                    ...
                    W('wdg.gl244','wdg.gl2',{
                      width: "200",
                      height: "200",
                      size: "11"},{"id":"wdg.gl244","name":"wdg.gl2"}),
                    "\r\n    "]}),
=======
                    "\n        ",
                    W('wdg.gl243','wdg.gl2',{
...
<<<<<<< HEAD
                    ...
                    W('wdg.gl245','wdg.gl2',{
                      width: "200",
                      height: "200",
                      size: "100"},{"id":"wdg.gl245","name":"wdg.gl2"}),
                    "\r\n    "]})]}),
=======
                    "\n        ",
                    W('wdg.gl244','wdg.gl2',{
...
<<<<<<< HEAD
                        "    \r\n        ",
                        W('wdg.chap2-triangles50','wdg.chap2-triangles',{
                          width: "160",
                          height: "160"},{"id":"wdg.chap2-triangles50"}),
                        "\r\n        ",
=======
                        "    \n        ",
                    ...
                    W({
                      ...
                      children: [
                        ...
                        W({
                          elem: "div",
<<<<<<< HEAD
                          children: [W('wdg.chap2-trifan51','wdg.chap2-trifan',{
                              width: "160",
                              height: "160"},{"id":"wdg.chap2-trifan51"})]}),
                        "\r\n        ",
=======
                    ...
                    W({
                      ...
                      children: [
                        ...
                        W({
                          elem: "div",
<<<<<<< HEAD
                          children: [W('wdg.chap2-tristrip52','wdg.chap2-tristrip',{
                              width: "160",
                              height: "160"},{"id":"wdg.chap2-tristrip52"})]}),
                        "\r\n        ",
=======
...
require("wdg.chap2-tristrip",function(t,r,o){var i=function(){function r(){return i(o,arguments)}var o={en:{},fr:{}},i=t("$").intl;return r.all=o,r}();r.exports=t("draw")(function(){function t(t,r,o){i.drawTri(n[t],s[t],n[r],s[r],n[o],s[o])}var r,o,i=this,n=[],s=[];for(r=0;r<6;r++)n.push(1*Math.cos(2*Math.PI*r/6)),s.push(1*Math.sin(2*Math.PI*r/6));for(this.setColor("#06F").setLine(4),r=0;r<6;r++)o=(r+1)%6,this.fillTri(0,0,n[r],s[r],n[o],s[o]).drawTri(0,0,n[r],s[r],n[o],s[o]);this.setColor("#F70").setLine(4),t(0,1,5),t(1,5,2),t(5,2,4),t(2,4,3),this.setColor("#000").dot(n[0],s[0],"A","L").dot(n[1],s[1],"B","LB").dot(n[2],s[2],"C","RB").dot(n[3],s[3],"D","R").dot(n[4],s[4],"E","RT").dot(n[5],s[5],"F","LT")}),r.exports._=i});
//# sourceMappingURL=wdg.chap2-tristrip.js.map
...
require("wdg.chap2-trifan",function(t,r,o){var i=function(){function r(){return i(o,arguments)}var o={en:{},fr:{}},i=t("$").intl;return r.all=o,r}();r.exports=t("draw")(function(){var t,r,o=[],i=[];for(t=0;t<6;t++)o.push(1*Math.cos(2*Math.PI*t/6)),i.push(1*Math.sin(2*Math.PI*t/6));for(this.setColor("#06F").setLine(4),t=0;t<6;t++)r=(t+1)%6,this.fillTri(0,0,o[t],i[t],o[r],i[r]).drawTri(0,0,o[t],i[t],o[r],i[r]);for(this.setColor("#F70"),t=1;t<6;t++)r=(t+1)%6,this.drawTri(o[0],i[0],o[t],i[t],o[r],i[r]);this.setColor("#000").dot(o[0],i[0],"A","L").dot(o[1],i[1],"B","LB").dot(o[2],i[2],"C","RB").dot(o[3],i[3],"D","R").dot(o[4],i[4],"E","RT").dot(o[5],i[5],"F","LT")}),r.exports._=i});
