...
addListener(
    ...
    function() {
        ...
        W('wdg.article35', 'wdg.article', {
          ...
          W({
              elem: "p",
              children: [W('wdg.lines136','wdg.lines1',{
                  float: "right",
                  width: "200",
                  height: "200"},{"id":"wdg.lines136"})]}),
          W({
              elem: "p",
              children: [
          ...
          W({
              elem: "p",
              children: [
                W('wdg.lines137','wdg.lines1',{
                  n: "50",
                  f: "3"},{"id":"wdg.lines137"}),
                "\n",
                W('wdg.lines138','wdg.lines1',{
                  n: "50",
                  f: "4"},{"id":"wdg.lines138"}),
                "\n",
                W('wdg.lines139','wdg.lines1',{
                  n: "50",
                  f: "5"},{"id":"wdg.lines139"})]}),
          W({
              elem: "h1",
