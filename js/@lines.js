...
addListener(
    ...
    function() {
        ...
        W('wdg.article115', 'wdg.article', {
          ...
          W({
              elem: "p",
              children: [W('wdg.lines1116','wdg.lines1',{
                  float: "right",
                  width: "200",
                  height: "200"},{"id":"wdg.lines1116"})]}),
          W({
              elem: "p",
              children: [
          ...
          W({
              elem: "p",
              children: [
                W('wdg.lines1117','wdg.lines1',{
                  n: "50",
                  f: "3"},{"id":"wdg.lines1117"}),
                "\n",
                W('wdg.lines1118','wdg.lines1',{
                  n: "50",
                  f: "4"},{"id":"wdg.lines1118"}),
                "\n",
                W('wdg.lines1119','wdg.lines1',{
                  n: "50",
                  f: "5"},{"id":"wdg.lines1119"})]}),
          W({
              elem: "h1",
