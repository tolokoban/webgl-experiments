...
addListener(
    ...
    function() {
        ...
        W('wdg.article85', 'wdg.article', {
          ...
          W({
              elem: "p",
              children: [W('wdg.lines186','wdg.lines1',{
                  float: "right",
                  width: "200",
                  height: "200"},{"id":"wdg.lines186"})]}),
          W({
              elem: "p",
              children: [
          ...
          W({
              elem: "p",
              children: [
                W('wdg.lines187','wdg.lines1',{
                  n: "50",
                  f: "3"},{"id":"wdg.lines187"}),
                "\n",
                W('wdg.lines188','wdg.lines1',{
                  n: "50",
                  f: "4"},{"id":"wdg.lines188"}),
                "\n",
                W('wdg.lines189','wdg.lines1',{
                  n: "50",
                  f: "5"},{"id":"wdg.lines189"})]}),
          W({
              elem: "h1",
...
require("wdg.lines1",function(t,r,o){var n=function(){function r(){return n(o,arguments)}var o={en:{},fr:{}},n=t("$").intl;return r.all=o,r}();r.exports=t("draw")(function(t){void 0===t.n&&(t.n=10),void 0===t.f&&(t.f=3);var r,o,n,i=t.n,s=t.f,e=[],f=[];for(r=0;r<i;r++)n=2*Math.PI*r/i,e.push(.95*Math.sin(n)),f.push(.95*Math.cos(n));for(this.setColor("#F70").setLine(4),r=0;r<i;r++)o=r*s%i,this.drawLine(e[r],f[r],e[o],f[o]);for(this.setColor("#000"),r=0;r<i;r++)this.dot(e[r],f[r]);for(this.setColor("#06D"),r=0;r<i;r++)this.txt(r,1.15*e[r],1.15*f[r])}),r.exports._=n});
//# sourceMappingURL=wdg.lines1.js.map
