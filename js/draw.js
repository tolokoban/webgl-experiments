...
/** @module draw */
require('draw', function (require, module, exports) {
  var _ = function () {
    var D = {
      "en": {},
      "fr": {}
  ...
  module.exports = function (init) {
    ...
    Draw.prototype.axes = function () {
      var ctx = this._ctx;
      ctx.save();
      this.setColor("#ddd").fillRect(-1, -1, 1, 1).setColor("#aaa");
      var w = this._w;
    ...
    Draw.prototype.fillQuad = function (x1, y1, x2, y2, x3, y3, x4, y4) {
      return this.fillTri(x1, y1, x2, y2, x3, y3).fillTri(x1, y1, x3, y3, x4, y4);
    };

    Draw.prototype.drawQuad = function (x1, y1, x2, y2, x3, y3, x4, y4) {
      return this.drawTri(x1, y1, x2, y2, x3, y3).drawTri(x1, y1, x3, y3, x4, y4);
    };
    ...
    Draw.prototype.txtL = function (text, x, y) {
      return this.txt(text, x, y, "L");
    };

    Draw.prototype.txtR = function (text, x, y) {
      return this.txt(text, x, y, "R");
    };

    Draw.prototype.txtT = function (text, x, y) {
      return this.txt(text, x, y, "T");
    };

    Draw.prototype.txtB = function (text, x, y) {
      return this.txt(text, x, y, "B");
    };

    Draw.prototype.txtLT = function (text, x, y) {
      return this.txt(text, x, y, "LT");
    };
    ...
    Draw.prototype.txtRT = function (text, x, y) {
      return this.txt(text, x, y, "RT");
    };

    Draw.prototype.txtRB = function (text, x, y) {
      return this.txt(text, x, y, "RB");
    };
  ...
  function getBestAttach(x, y) {
    ...
    return ["L", "LB", "B", "RB", "R", "RT", "T", "LT"][index];
  }
