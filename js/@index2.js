...
addListener(
    ...
    function() {
        ...
        W('wdg.article110', 'wdg.article', {"content": [
          ...
          W({
              elem: "h1",
              attr: {"id": "sp-cifier-des-couleurs-variables"},
              children: ["Spécifier des couleurs variables"]}),
          W({
              elem: "p",
              children: [
                "Dans le chapitre précédent, nous avons vu comment dessiner le triangle ci dessus, mais il était d",
                "&#39;",
                "une seule couleur.\nVoyons comment on peut facilement obtenir cet effet de dégradé. Pour cela revenons sur le fragment shader puisque c",
                "&#39;",
                "est lui qui est responsable de la couleur des pixels."]}),
          W({
              elem: "p",
              children: [W({
                  elem: "pre",
          ...
          W({
              elem: "p",
              children: [
                "Si on regarde bien ce triangle (un brin hypnotique), on remarque qu",
                "&#39;",
                "un sommet est rouge, un autre bleu et le dernier vert. Ce sont les pixels les plus loins des sommets qui sont les plus ",
                "&quot;",
                "dégragés",
                "&quot;",
                "."]}),
          W({
              elem: "p",
              children: ["On va donc ajouter un nouvel attribut à nos vertex : la couleur."]}),
          W({
              elem: "p",
              children: [
