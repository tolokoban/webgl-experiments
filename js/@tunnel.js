...
>>>>>>> 087a08f948b2fa3cb3efb25e138c5b93962066cd
          ...
          W({
              elem: "p",
<<<<<<< HEAD
              children: [W('wdg.tunnel1113','wdg.tunnel1',{"float": "right"},{"id":"wdg.tunnel1113"})]}),
=======
...
require("wdg.tunnel1",function(r,n,t){function o(r,n){var t,o,a,i=[];for(o=0;o<n-1;o++){for(t=o*r,a=0;a<r;a++)i.push(t+a,t+a+r);i.push(t)}return i.push(t+r),i}function a(r,n,t){Array.isArray(r)||(r=[r]),Array.isArray(n)||(n=[n]);var o=[];r.forEach(function(r,a){var i=n[a];o.push(Math.floor((1-t)*r+t*i))});var a=o[0].toString(16);a.length<2&&(a="0"+a);var i=o[1].toString(16);i.length<2&&(i="0"+i);var h=o[2].toString(16);return h.length<2&&(h="0"+h),"#"+a+i+h}var i=function(){function n(){return o(t,arguments)}var t={en:{},fr:{}},o=r("$").intl;return n.all=t,n}();n.exports=r("draw")(function(){var r,n,t,i=[],h=[],u=1;for(n=0;n<3;n++){for(r=0;r<3;r++)t=2*Math.PI*r/3,i.push(u*Math.sin(t)),h.push(u*Math.cos(t));u*=.5}var e=o(3,3);console.log(e.join(" | "));for(var s=0;s<e.length-2;s++){var f=a([200,100,0],[255,255,255],s/e.length);console.info("[wdg.tunnel1] color=",f),this.setColor(f).fillTri(i[e[s]],h[e[s]],i[e[s+1]],h[e[s+1]],i[e[s+2]],h[e[s+2]])}this.setColor("#000"),i.forEach(function(r,n){var t=h[n];this.dot(r,t,""+n,"B")},this)}),n.exports._=i});
//# sourceMappingURL=wdg.tunnel1.js.map
