...
require('wdg.menu.item', function (require, module, exports) {
  var _ = function () {
    var D = {
      "en": {
        "href": "$1.html?id=$1",
        "img": "css/assets/index/$1.jpg"
      }
    },
        X = require("$").intl;
    ...
    module.exports = function () {
      ...
      var ViewClass = function ViewClass(args) {
        try {
          ...
          var e_ = new Tag('A', ["class", "href", "name"]);
          ...
          pm.set("id", defVal(args, "id", ""));
          pm.set("title", defVal(args, "title", ""));
          pm.set("keywords", defVal(args, "keywords", ""));
          pm.fire("id");
          pm.fire("title");
          pm.fire("keywords");
...
//# sourceMappingURL=wdg.menu.item.js.map