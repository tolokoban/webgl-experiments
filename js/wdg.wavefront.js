...
try {
  module.exports = function() {
    ...
    var TfwViewColorInput = require('tfw.view.color-input');
    //-------------------------------------------------------
    ...
    var ViewClass = function( args ) {
      try {
        ...
        $.add( e_8, e_9, e_A );
        var e_B = new Tag('DIV');
        var e_C = new Tag('SPAN');
        $.add( e_C, "Triangles" );
        var e_D = new Tag('B', ["textcontent"]);
        $.add( e_B, e_C, e_D );
        var e_E = new Tag('DIV');
        var e_F = new Tag('SPAN');
        $.add( e_F, "Vertices" );
        var e_G = new Tag('B', ["textcontent"]);
        $.add( e_E, e_F, e_G );
        var e_H = new Tag('DIV');
        var e_I = new Tag('SPAN');
        $.add( e_I, "Elements" );
        var e_J = new Tag('B', ["textcontent"]);
        $.add( e_H, e_I, e_J );
        ...
        var e_M = new TfwViewCheckbox({
          wide: false,
          content: "Afficher le liseré"
        });
        var e_N = new TfwViewTextbox({
          label: "Épaisseur",
          width: "40px"
        });
        var e_O = new TfwViewCombo({
          items: [
            "Hachures",
            "Couleurs franches",
            "Lisse",
        ...
        var e_P = new TfwViewColorInput();
        var e_L = new TfwViewFlex({
          justifyContent: "space-around",
          flexWrap: "wrap",
          content: [
            e_M,
        ...
        new Link({
          ...
          B:{obj: e_D,
              name: 'textcontent'},
          name:"triangle-count > e_D/textcontent"
        });
        new Link({
          A:{obj: that,
              name: 'vertCount'},
          B:{obj: e_G,
              name: 'textcontent'},
          name:"vert-count > e_G/textcontent"
        });
        new Link({
          A:{obj: that,
              name: 'elemCount'},
          B:{obj: e_J,
              name: 'textcontent'},
          name:"elem-count > e_J/textcontent"
        });
        new Link({
          A:{obj: that,
              name: 'borderVisible'},
        ...
        new Link({
          ...
          B:{obj: e_N,
              name: 'value'},
          name:"border-thickness > e_N/value"
        });
        new Link({
          A:{obj: that,
              name: 'material'},
        ...
        this.material = defVal(args, "material", 0);
        this.color = defVal(args, "color", "#ff8800");
        // Initialization.
