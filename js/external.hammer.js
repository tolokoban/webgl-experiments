...
/** @module external.hammer */
require('external.hammer', function (require, module, exports) {
  var _ = function () {
    var D = {
      "en": {},
      "fr": {}
  ...
  (function (window, document, exportName, undefined) {
    ...
    function computeInputData(manager, input) {
      var session = manager.session,
          ...
          pointersLength = pointers.length; // store the first input to calculate the distance and direction
    ...
    function computeIntervalInputData(session, input) {
      ...
      var velocity, velocityX, velocityY, direction;
