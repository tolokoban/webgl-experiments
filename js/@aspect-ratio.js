        ...
        W('wdg.article0', 'wdg.article', {
          ...
          W({
              ...
              children: [
                ...
                "est pas préoccupé d",
                "&#39;",
                "un problème qui est pourtant essentiel en animation : ",
                W({
                  elem: "strong",
                  children: [
                    "faire en sort qu",
                    "&#39;",
                    "un carré reste carré, même sur un écran rectangulaire"]}),
                ". C",
                "&#39;",
                "est ce qu",
                "&#39;",
          ...
          W({
              ...
              children: [
                "WebGL ne s",
                "&#39;",
                "en soucie guère puisqu",
                "&#39;",
                "il utilise un système de coordonnées calqué sur la forme de l",
                "&#39;",
                "écran. Ainsi, sur un écran en mode paysage (un écran d",
                "&#39;",
                "ordinateur, par exemple), avancer d",
                "&#39;",
                "une unité suivant X nous fait parcourir plus de pixels que d",
                "&#39;",
                "avancer de la même unité suivant Y."]}),
          W({
              elem: "p",
              children: [W('wdg.aspect-ratio1','wdg.aspect-ratio',{},{"id":"wdg.aspect-ratio1","class":"right"})]}),
          W({
              elem: "p",
              children: [
                "Il y a deux possibilités de rendre l",
                "&#39;",
                "espace ",
                W({
                  elem: "strong",
              ...
              children: [
                ...
                W({
                  ...
                  children: [
                    ...
                    W({
                      elem: "a",
                      attr: {"href": "css/assets/aspect-ratio/a/index.html"},
                      children: ["l'espace de dessin est entièrement contenu dans l'affichage"]}),
                    "."]}),
                "\n",
                W({
                  elem: "li",
                  children: [
                    ...
                    W({
                      elem: "a",
                      attr: {"href": "css/assets/aspect-ratio/b/index.html"},
                      children: ["l'espace de dessin recouvre entièrement l'affichage"]}),
                    "."]}),
                "\n"]}),
          W({
              elem: "p",
              children: [
                "Dans le scéma ci-contre, on peut voir comment on modifie les coordonnées sur un écran en mode paysage (le rectangle plein de couleur bleue). Le petit carré orange correspond au ",
                W({
                  elem: "strong",
                  children: ["contain"]}),
                ", et le grand au ",
          ...
          W({
              elem: "p",
              children: [
                "Les calculs pour modifier les coordonnées s",
                "&#39;",
                "effectuent dans le vertex shader."]}),
          W({
              elem: "p",
              children: [
          ...
          W({
              elem: "p",
              children: [
                "Puisque WebGL ne sait pas quelle forme à l",
                "&#39;",
                "écran, il faut le lui dire en utilisant les uniforms avec la taille réelle du canvas."]}),
          W({
              elem: "p",
              children: [W({
                  elem: "pre",
          ...
          W({
              elem: "p",
              children: [
                "Au passage, on redéfinit les attributs du ",
                W({
                  elem: "em",
                  children: ["canvas"]}),
                " pour qu",
