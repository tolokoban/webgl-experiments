...
require('tfw.focusable', function (require, module, exports) {
  var _ = function () {
    var D = {
      "en": {},
      "fr": {}
  ...
  var Focusable = function Focusable(widget, onKeyDown) {
    if (typeof onKeyDown !== 'function') onKeyDown = function onKeyDown() {};
    ...
    DB.propBoolean(widget, 'focus')(function (v) {
      window.setTimeout(function () {
        if (v) input.focus();else input.blur();
      });
    });
  };
