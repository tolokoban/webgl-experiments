...
addListener(
    ...
    function() {
        ...
        W('wdg.article153', 'wdg.article', {
          ...
          W({
              elem: "p",
              children: [W('wdg.vectorDrawing3154','wdg.vectorDrawing3',{
                  width: "300",
                  height: "300",
                  index: "1"},{"id":"wdg.vectorDrawing3154","class":"right"})]}),
          W({
              elem: "p",
              children: [
          ...
          W({
              ...
              children: [
                ...
                " points d",
                "&#39;",
                "une courbe fermée qui englobe une seule surface. Mais ",
                W({
                  elem: "strong",
                  children: [
                    "il ne fonctionne que si aucun segment n",
                    "&#39;",
                    "en croise un autre"]}),
                "."]}),
          W({
                      ...
                      children: [
                        ...
                        W({
                          ...
                          children: [
                            ...
                            ", l",
                            "&#39;",
                            "indice du premier point du prochain ",
                            W({
                              elem: "strong",
          ...
          W({
              elem: "p",
              children: [W('wdg.matrix155','wdg.matrix',{"value": "[x;y;z]^[x';y';z'] = [yz'-y'z;x'z-xz';xy'-x'y]"},{"id":"wdg.matrix155"})]}),
          W({
              elem: "p",
              children: [
                "Puisque nos vecteurs sont dans un même plan, ils sont définis par deux coordonnées : ",
                W({
                  elem: "code",
                  children: ["(X,Y)"]}),
          ...
          W({
              elem: "p",
              children: [W('wdg.matrix156','wdg.matrix',{"value": "[x;y;0]^[x';y';0] = [0;0;xy'-x'y]"},{"id":"wdg.matrix156"})]}),
          W({
              elem: "p",
              children: [
          ...
          W({
              elem: "p",
              children: [W('wdg.vectorDrawing157','wdg.vectorDrawing',{},{"id":"wdg.vectorDrawing157","class":"right"})]}),
          W({
              elem: "p",
              children: [
                "Dans l",
          ...
          W({
              elem: "p",
              children: [
                "Il est facile de savoir si deux angles sont de même nature : il suffit que leurs produits vectoriels respectifs soient de même signe. Il faut donc déterminer la concavité du premier angle, mais c",
                "&#39;",
          ...
          W({
              elem: "p",
              children: [W('wdg.vectorDrawing2158','wdg.vectorDrawing2',{},{"id":"wdg.vectorDrawing2158","class":"right"})]}),
          W({
              elem: "p",
          ...
          W({
              ...
              children: [
                ...
                "\n",
                W('wdg.vectorDrawing3167','wdg.vectorDrawing3',{
                  width: "300",
                  height: "300",
                  index: "6"},{"id":"wdg.vectorDrawing3167"})]}),
          W({
              elem: "p",
              children: [W({
                  elem: "pre",
...
require("wdg.vectorDrawing3",function(t,r,n){function a(t){switch(t){case 0:return o();case 1:return e();case 2:return h();case 3:return i();case 4:return s();case 5:return c()}return u()}function e(){return[0,.7,.3,0,1,.4,.9,0,.5,-.4,-.5,-.4,-.9,0,-1,.4,-.3,0]}function o(){return[.2,1,1,-.2,-.9,-.7]}function h(){for(var t,r=[],n=0;n<10;n++)t=.3+n%2*.6,r.push(t*Math.sin(Math.PI*n/5),t*Math.cos(Math.PI*n/5));return r}function i(){for(var t=.95,r=[],n=0;n<6;n++)t=.2+n%2*.6,r.push(t*Math.cos(2*Math.PI*n/6),t*Math.sin(2*Math.PI*n/6));return r}function s(){var t,r,n=10,a=[];for(r=0;r<n;r++)t=1-.7*r/n,a.push(t*Math.cos(3*Math.PI*r/n),t*Math.sin(3*Math.PI*r/n));for(r=9;r>-1;r--)t=.7-.6*r/n,a.push(t*Math.cos(3*Math.PI*r/n),t*Math.sin(3*Math.PI*r/n));return a}function u(){for(var t,r=[],n=0;n<8;n++)t=.75*Math.random()+.25,r.push(t*Math.cos(2*Math.PI*n/8),t*Math.sin(2*Math.PI*n/8));return r}function c(){var t=.4+.6*Math.random(),r=.4+.6*Math.random(),n=.4+.6*Math.random();return[-.6,t,-.3,t,-.3,.2,-.1,.2,-.2,r,.2,r,.1,.2,.3,.2,.3,n,.6,n,.5,0,.3,-.2,.4,-1,-.4,-1,-.3,-.2,-.5,0]}var f=function(){function r(){return a(n,arguments)}var n={en:{},fr:{}},a=t("$").intl;return r.all=n,r}(),l=t("webgl.fillpoly");r.exports=t("draw")(function(t){console.info("[wdg.vectorDrawing3] args=",t);var r=a(parseInt(t.index)),n=l.fillPolyline(r);console.info("[wdg.vectorDrawing3] elemBuff=",n);var e,o,h,i,s,u,c,f,M,g;for(e=0;e<n.length;e+=3)o=2*n[e],h=r[o],i=r[o+1],o=2*n[(e+1)%n.length],s=r[o],u=r[o+1],o=2*n[(e+2)%n.length],c=r[o],f=r[o+1],this.setOpacity(.5).setColor(this.ORANGE).fillTri(h,i,s,u,c,f),M=(h+s+c)/3,g=(i+u+f)/3,this.setOpacity(1).setColor(this.BLUE).txt(Math.floor(e/3),M,g,"");for(this.setOpacity(1).setLine(2).setColor(this.BLUE),e=0;e<n.length;e+=3)o=2*n[e],h=r[o],i=r[o+1],o=2*n[(e+1)%n.length],s=r[o],u=r[o+1],o=2*n[(e+2)%n.length],c=r[o],f=r[o+1],this.drawTri(h,i,s,u,c,f);for(this.setColor("#000"),e=0;e<r.length;e+=2)h=r[e],i=r[e+1],this.dot(h,i,"ABCDEFGHIJKLMNOPQRSTUVWXYZ".charAt(e/2))}),r.exports._=f});
//# sourceMappingURL=wdg.vectorDrawing3.js.map
require("webgl.fillpoly",function(t,r,e){function i(t){try{var r=[];if(t.length<3)throw"[webgl.fillpoly.vertexArrayToAttribs] A polyline must have at least 3 vertices!";var e,i,n,o,s,h,c,l=t[1][0]-t[0][0],a=t[1][1]-t[0][1],u=t[1][2]-t[0][2];for(o=2;o<t.length&&(e=t[o][0]-t[0][0],i=t[o][1]-t[0][1],n=t[o][2]-t[0][2],s=a*n-u*i,h=u*e-l*n,c=l*i-a*e,!(s*s+h*h+c*c>0));o++);return t.forEach(function(t){var o=t[0],s=t[1],h=t[2];r.push(l*o+a*s+u*h,e*o+i*s+n*h)}),new Float32Array(r)}catch(r){throw console.error("[webgl.fillpoly.vertexArrayToAttribs] error = ",r),console.error("[webgl.fillpoly.vertexArrayToAttribs] vectors3 = ",t),r+"\n...in webgl.fillpoly.vertexArrayToAttribs"}}function n(t,r,e){void 0===r&&(r=2),void 0===e&&(e=0);var i=new c(t,r),n=Math.floor(t.length/r),s=n-2,h=o(-1,i,e,r);return h&&h.length===3*s?h:(i=new c(t,r),new Uint16Array(o(1,i,e,r)))}function o(t,r,e,i){for(var n,o,s,h=[];r.length>3;){for(var c=0;!r.isCandidate(t)&&c++<r.length;)c++,r.next();if(c>=r.length)return null;n=r.get(),h.push(e+n.index,e+n.next,e+n.prev),r.removeTriangle(n.index,n.next,n.prev)}return r.isCandidate(t)?(n=r.get(),o=r.get(n.next),s=r.get(n.prev),h.push(e+n.index,e+o.index,e+s.index),h):null}function s(t){var r="";return Array.prototype.slice.call(arguments).forEach(function(t){r+=l.charAt(t)}),r}var h=function(){function r(){return i(e,arguments)}var e={en:{},fr:{}},i=t("$").intl;return r.all=e,r}();e.fillPolyline=n,e.vertexArrayToAttribs=i;var c=function(t,r){for(var e=[],i=Math.floor(t.length/r),n=0;n<i;n++)e.push([n*r,(n+i-1)%i,(n+1)%i]);this.length=i,this._vertices=t,this._cursor=0,this._points=e};c.prototype.isCandidate=function(t){var r=this._cursor,e=this.get(r),i=e.next,n=e.prev,o=this.getVector(r,i),s=this.getVector(r,n),h=this.cross(o,s);if(h>0&&t>0)return!1;if(h<0&&t<0)return!1;for(var c=0;c<this._points.length;c++)if(c!==r&&c!==i&&c!==n&&this.isInTriangle(r,c,t))return!1;return!0},c.prototype.get=function(t){void 0===t&&(t=this._cursor);var r=this._points[t],e=r[0];return{index:t,next:r[2],prev:r[1],x:this._vertices[e],y:this._vertices[e+1]}},c.prototype.getVector=function(t,r){var e=this.get(t),i=this.get(r);return{x:i.x-e.x,y:i.y-e.y}},c.prototype.cross=function(t,r){return t.x*r.y-t.y*r.x},c.prototype.isInTriangle=function(t,r,e){var i=this.get(t),n=i.next,o=i.prev;return e>0?this.isInTrianglePos(t,n,o,r):this.isInTriangleNeg(t,n,o,r)},c.prototype.isInTriangleNeg=function(t,r,e,i){var n=this.getVector(t,r),o=this.getVector(t,i);if(this.cross(n,o)<0)return!1;var s=this.getVector(r,e),h=this.getVector(r,i);if(this.cross(s,h)<0)return!1;var c=this.getVector(e,t),l=this.getVector(e,i);return!(this.cross(c,l)<0)},c.prototype.isInTrianglePos=function(t,r,e,i){var n=this.getVector(t,r),o=this.getVector(t,i);if(this.cross(n,o)>0)return!1;var s=this.getVector(r,e),h=this.getVector(r,i);if(this.cross(s,h)>0)return!1;var c=this.getVector(e,t),l=this.getVector(e,i);return!(this.cross(c,l)>0)},c.prototype.next=function(){var t=this._cursor;this._cursor=this._points[t][2]},c.prototype.removeTriangle=function(t,r,e){this._points[e][2]=r,this._points[r][1]=e,this.length--,this._cursor=r;var i="",n=r;do{i+=s(n),n=this._points[n][2]}while(n!==r)};var l="ABCDEFGHIJKLMNOPQRSTUVWXYZ";r.exports._=h});
