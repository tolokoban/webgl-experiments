...
addListener(
    ...
    function() {
        ...
        W('wdg.article44', 'wdg.article', {"content": [
          W({
              elem: "p",
              children: [
                "  ",
                W('wdg.flex45','wdg.flex',{"content": [
                  W({
                      elem: "center",
                      children: [
                        "\n        ",
                        W({
                          ...
                          children: [
                            ...
                            " tri Javascript"]}),
                        "\n        ",
                        W('wdg.gl6-246','wdg.gl6-2',{
                          width: "420",
                          height: "420"},{"id":"wdg.gl6-246"}),
                        "\n      "]}),
                  W({
                      elem: "center",
                      children: [
                        ...
                        W({
                          ...
                          children: [
                            ...
                            " tri Javascript"]}),
                        "\n        ",
                        W('wdg.gl6-247','wdg.gl6-2',{
                          width: "420",
                          height: "420",
                          sort: "true"},{"id":"wdg.gl6-247"}),
                        "\n    "]})]},{"id":"wdg.flex45"})]}),
          W({
              elem: "p",
